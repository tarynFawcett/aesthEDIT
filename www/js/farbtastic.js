...
jQuery._farbtastic = function (container, callback) {
  ...
  fb.setColor = function (color) {
    ...
    if (fb.color != color && unpack) {
      ...
      fb.updateDisplay();
	  		//////---tested the color here, recognizes the color change after the browser has been refreshed---/////
	  		//drawingColor = color;
			//alert(drawingColor);
  ...
  fb.updateDisplay = function () {
	...
	drawingColor = fb.color;
	$('#brushTiny, #brushSmall, #brushMedium, #brushLarge').css("background-color", drawingColor);
  }
